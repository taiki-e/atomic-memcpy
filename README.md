...
- If the type being copied contains uninitialized bytes (e.g., padding) [it is undefined behavior because the copy goes through integers][undefined-behavior]. You can work around the undefined behavior by enabling the `inline-asm` feature of this crate.
